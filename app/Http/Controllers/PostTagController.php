...
class PostTagController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Tag Postingan Berhasil di Tambahkan');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Tag Postingan Berhasil di Buat');
        }
        else{
            request()->session()->flash('error','Mohon Coba Lagi!!');
        }
    ...
    public function destroy($id)
    {
        ...
        if($status){
            request()->session()->flash('success','Tag Postingan Berhasil di Hapus');
        }
        else{
            request()->session()->flash('error','Error Saat Tag di Hapus');
        }
        return redirect()->route('post-tag.index');
    }
}
