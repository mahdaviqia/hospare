                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="blog-single.html">Halaman Belanja</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        <a data-toggle="modal" data-target="#{{$product->id}}" title="Lihat" href="#"><i class=" ti-eye"></i><span>Lihat Produk</span></a>
